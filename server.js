...
const htmlPathMap = new Map( 
	readdirSync(__dirName)
		...
		.map( (path)=>[path === "index.html" ? "/" : "/"+path.slice(0, -5), path] )
);
...
async function createServer()
{
	...
	app.listen(5173);
	// console log
	console.log("\x1b[32mstart VITE hmr-ssg server\x1b[39m : \x1b[36mhttp://localhost\x1b[1m:5173\x1b[22m\x1b[39m");
	console.log("\x1b[90mpress \x1b[39m\x1b[1mcontrol + C\x1b[22m \x1b[90mto close server\x1b[39m");
}
