...
function QnAArticle({question, answer})
{
	...
	const staticIconStyle = "size-[1.8181818em] transition-transform ease-in-out-cubic";

	return <article className="w-full max-w-[1200px] flex flex-col gap-4 md:gap-6 lg:gap-8 py-6 text-body-s md:text-body-m lg:text-body-l">
		<div className="flex justify-between items-center" onClick={onClick}>
			<h3 className="flex gap-2 lg:gap-3 font-bold text-black">
