...
function FastChargeInteraction({interacted, $ref})
{
	...
	return <article className="bg-black w-full h-full overflow-hidden flex justify-center flex-col">
		<div className="w-full max-w-[1200px] px-20 text-white">
			<h3 className="text-neutral-400">불편함 없이, 더 빠르게</h3>
			<p className="text-white">The new IONIQ 5의 배터리를 충전하는 데 얼마만큼의 시간이 걸릴까요?</p>
			<p className="text-white">다이얼을 돌려 충전에 필요한 시간을 확인해보세요!</p>
		</div>
