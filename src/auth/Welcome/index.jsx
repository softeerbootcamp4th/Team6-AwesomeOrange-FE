...
function WelcomeModal()
{
	...
	<div className="w-[calc(100%-1rem)] max-w-[31.25rem] h-[calc(100svh-2rem)] max-h-[40.625rem] p-6 min-[520px]:px-[5rem] pt-10 pb-[4.75rem] shadow bg-white relative flex flex-col justify-between">
		...
		<img className="absolute top-[calc(50%-91px)] left-[calc(50%-86.5px)]" src="/icons/register@1x.png" srcSet="/icons/register@1x.png 1x, /icons/register@2x.png 2x" alt="정보 등록 완료" width="173" height="182" />
		<div className="w-full flex justify-center relative">
			<Button styleType="filled" onClick={close}>확인</Button>
		</div>
		<button
