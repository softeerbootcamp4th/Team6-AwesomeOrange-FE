    ...
    <div className="w-full h-[29rem]">
      <AutoScrollCarousel speed={0.2} gap={28}>
        {comments.map(({ id, content, userName, createdAt }) => (
          <div className="w-72 h-96 mt-10 bg-neutral-50 p-8 flex flex-col justify-between gap-10 hover:scale-110 transition-transform duration-200 ease-in-out-cubic" key={id}>
